...
export const Route = createFileRoute("/evidence")({
  head: () => ({
    meta: [
      { title: "Evidence Upload & OCR Analysis — CrimeSight AI" },
      {
        name: "description",
        content:
          "Upload FIRs, scanned reports, or evidence documents for AI extraction, intelligence summary, and network linking.",
      },
    ],
  }),
...
function EvidencePage() {
  ...
  async function handleUpload() {
    ...
    try {
      const response = await api.uploadEvidence(evidence.file);
